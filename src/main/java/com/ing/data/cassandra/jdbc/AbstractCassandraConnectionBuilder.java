...
/**
 * Abstract Cassandra connection builder implementing builder methods for {@link ConnectionBuilder} and
 * {@link PooledConnectionBuilder} implementations.
 *
 * @param <C> Type of connection to build: {@link Connection} or {@link PooledConnection}.
 */
@Slf4j
public abstract class AbstractCassandraConnectionBuilder<C> {
     ...
     *
     * @param username The username to use for this connection.
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> user(final String username) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> password(final String password) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> contactPoints(final List<ContactPoint> contactPoints) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> astraDatabaseName(final String astraDatabaseName) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> databaseName(final String databaseName) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> complianceMode(final String complianceMode) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> consistency(final String consistency) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> serialConsistency(final String consistency) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> localDataCenter(final String localDataCenter) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> activeProfile(final String profile) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> retryPolicy(final String policy) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> loadBalancingPolicy(final String policy) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> reconnectionPolicy(final String policy) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> fetchSize(final Integer fetchSize) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> sslEnabled(final boolean enabled) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> sslEngineFactory(final String factory) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> hostnameVerified(final boolean enabled) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> secureConnectBundle(final String bundlePath) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> secureConnectBundle(final Path bundlePath) {
        return runThenReturnBuilder(() -> this.dataSource.setSecureConnectBundle(bundlePath));
    }
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> token(final String token) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> astraRegion(final String region) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> kerberosAuthProviderEnabled(final boolean enabled) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> requestTimeout(final Long timeout) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> connectionTimeout(final Long timeout) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> tcpNoDelayEnabled(final boolean enabled) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> tcpKeepAliveEnabled(final boolean enabled) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> configurationFile(final String configurationFile) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> configurationFile(final Path configurationFilePath) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> awsRegion(final String region) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> awsRegion(final Region region) {
        return runThenReturnBuilder(() -> this.dataSource.setAwsRegion(region));
    }
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> awsSecretRegion(final String region) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> awsSecretRegion(final Region region) {
        return runThenReturnBuilder(() -> this.dataSource.setAwsSecretRegion(region));
    }
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> awsSecretName(final String secretName) {
     ...
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> sigV4AuthProviderEnabled(final boolean enabled) {
        return runThenReturnBuilder(() -> this.dataSource.setSigV4AuthProviderEnabled(enabled));
    }

    /**
     * Specifies the sharding key to be used when creating a connection.
     *
     * @param shardingKey The sharding key to use for this connection.
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> shardingKey(final ShardingKey shardingKey) {
        // Sharding keys are not supported, this is a no-op method.
        return runThenReturnBuilder(() -> log.warn(UNSUPPORTED_SHARDING_KEYS));
    }

    /**
     * Specifies the super sharding key to be used when creating a connection.
     *
     * @param shardingKey The super sharding key to use for this connection.
     * @return The same {@link AbstractCassandraConnectionBuilder} instance.
     */
    public AbstractCassandraConnectionBuilder<C> superShardingKey(final ShardingKey shardingKey) {
     ...
     */
    public abstract C build() throws SQLException;

    private AbstractCassandraConnectionBuilder<C> runThenReturnBuilder(final Runnable operation) {
        operation.run();
        return this;
    }
